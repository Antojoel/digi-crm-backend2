...
router.get(
  ...
  [
    ...
    query('stage').optional().isIn(['new', 'contacted', 'analysis', 'proposal', 'negotiation', 'won', 'hold', 'progress', 'completed', 'lost']).withMessage('Invalid stage')
  ],
...
router.post(
  ...
  [
    ...
    body('stage').optional().isIn(['new', 'contacted', 'analysis', 'proposal', 'negotiation', 'won', 'hold', 'progress', 'completed', 'lost']).withMessage('Invalid stage'),
